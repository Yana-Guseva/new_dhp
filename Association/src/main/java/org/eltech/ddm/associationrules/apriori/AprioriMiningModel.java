...
public class AprioriMiningModel extends AssociationRulesMiningModel {
	...
	public final static int LARGE_ITEM_SETS_SET = 4;

	public static final int[] INDEX_LARGE_ITEM_SETS_SET = {LARGE_ITEM_SETS_SET};
...
//	private int currentLargeItemSets;
	...
	public int getCurrentLargeItemSetsIndex() {
		Integer index = currents.get(Arrays.toString(INDEX_LARGE_ITEM_SETS_SET));
		if(index == null)
			return -1;
		return index;
	}
