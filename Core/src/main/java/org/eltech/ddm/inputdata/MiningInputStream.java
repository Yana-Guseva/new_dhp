...
public abstract class MiningInputStream implements Cloneable, Serializable //extends com.prudsys.pdm.Cwm.Core.Class implements MiningVectorSet
{
	...
	protected EAttributeAssignmentSet attributeAssignmentSet;      //
	...
	protected ELogicalData userLogicalData;

	private ArrayList<Integer> unusesAttributeIndexes;

	private AttributeVectorPool instancePool;
	// -----------------------------------------------------------------------
	//  Constructor
	// -----------------------------------------------------------------------
	/**
