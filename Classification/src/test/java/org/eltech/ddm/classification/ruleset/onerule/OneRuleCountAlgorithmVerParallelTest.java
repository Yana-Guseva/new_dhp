...
public class OneRuleCountAlgorithmVerParallelTest extends RuleSetModelTest {
	...
	public void setUp() throws Exception {
		...
		algorithmSettings.setName(OneRuleCountAlgorithmVerParallel.class.getSimpleName());
		algorithmSettings.setClassname(OneRuleCountAlgorithmVerParallel.class.getName());
	...
	private EMiningBuildTask createBuidTask() throws MiningException{
		...
		MiningAlgorithm algorithm = new OneRuleCountAlgorithmVerParallel(miningSettings);
